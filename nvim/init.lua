...
-- NOTE: Nerd Font on WSL, download, unzip and install then click properties on terminal
-- NOTE: Using ZedMono
...
--  See `:help 'clipboard'`
--  NOTE: SCOOP INSTALL win32yank for WSL
...
vim.keymap.set("n", "<leader>t", function()
	if vim.fn.exists("g:VimuxRunnerIndex") == 1 then
		vim.cmd("call VimuxCloseRunner()")
	else
		vim.cmd("call VimuxOpenRunner()")
	end
end, { silent = true, noremap = true })

vim.keymap.set("n", "<leader>r", function()
	vim.cmd("write") --Save the file before running file
	...
	elseif filetype == "cpp" then
		...
		command = "g++ " .. filepath .. " -o " .. output_file .. " && ./" .. output_file
	elseif filetype == "c" then
		local output_file = vim.fn.expand("%:r")
		command = "gcc " .. filepath .. " -o " .. output_file .. " && ./" .. output_file
...
require("lazy").setup({
	...
	-- NOTE: gcc for inline comments, gbc for block comments
	{
